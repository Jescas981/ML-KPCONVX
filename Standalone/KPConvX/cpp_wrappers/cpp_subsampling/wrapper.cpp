...
static PyObject* furthest_point_sampling(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	// Create output array
	PyArrayObject* res_points_obj = (PyArrayObject*)PyArray_SimpleNew(1, sub_dims, NPY_INT);
	PyObject* ret = NULL;
...
static PyObject* batch_grid_partitionning(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	PyArrayObject* res_points_obj = (PyArrayObject*)PyArray_SimpleNew(2, point_dims, NPY_FLOAT);
	PyArrayObject* res_batches_obj = (PyArrayObject*)PyArray_SimpleNew(1, batches_dims, NPY_INT);
	PyArrayObject* res_ups_obj = (PyArrayObject*)PyArray_SimpleNew(2, up_dims, NPY_INT);
	PyArrayObject* res_pools_obj = (PyArrayObject*)PyArray_SimpleNew(2, pool_dims, NPY_INT);
	PyObject* ret = NULL;
