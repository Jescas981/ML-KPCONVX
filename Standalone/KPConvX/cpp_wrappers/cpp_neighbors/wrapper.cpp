...
static PyObject* batch_radius_neighbors(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	PyArrayObject* queries_array = (PyArrayObject*)PyArray_FROM_OTF(queries_obj, NPY_FLOAT, NPY_ARRAY_IN_ARRAY);
	PyArrayObject* supports_array = (PyArrayObject*)PyArray_FROM_OTF(supports_obj, NPY_FLOAT, NPY_ARRAY_IN_ARRAY);
	PyArrayObject* q_batches_array = (PyArrayObject*)PyArray_FROM_OTF(q_batches_obj, NPY_INT, NPY_ARRAY_IN_ARRAY);
	PyArrayObject* s_batches_array = (PyArrayObject*)PyArray_FROM_OTF(s_batches_obj, NPY_INT, NPY_ARRAY_IN_ARRAY);
...
static PyObject* batch_knn_neighbors(PyObject* self, PyObject* args, PyObject* keywds)
{
	...
	// Create output array
	PyArrayObject* res_obj_n = (PyArrayObject*)PyArray_SimpleNew(2, neighbors_dims, NPY_INT);
	PyArrayObject* res_obj_d2 = (PyArrayObject*)PyArray_SimpleNew(2, neighbors_dims, NPY_FLOAT);
	PyObject* ret = NULL;
