...
#
#   KPConvX project: plot_Lima3D.py
#       > Plotting script for Lima3D experiments
#
...
def experiment_name_1():
    ...
    end = 'Log_2027-07-29_12-40-27'

    # Name of the result path
    res_path = '/home/scantec/ml-kpconvx/Standalone/KPConvX/results'
...
if __name__ == '__main__':
    ...
    frame_lines_1(["Plot Lima3D experiments"])
    ...
    # Verify that we are dealing with Lima3D logs
    for cfg in all_cfgs:
        if not cfg.data.name.startswith('Lima3D'):
            err_mess = '\nTrying to plot Lima3D experiments, but {:s} was trained on {:s} dataset.'
